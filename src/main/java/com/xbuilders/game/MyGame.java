...
public class MyGame extends Game {
    ...
    public static final Block BLOCK_BIRCH_LOG = new Block(2, "Birch Log", new BlockTexture("birch log.png", "birch log.png", "birch log side.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_GLASS = new Block(8, "Glass", new BlockTexture("glass.png", "glass.png", "glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_GRASS = new Block(9, "Grass", new BlockTexture("grass.png", "dirt.png", "grass side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_OAK_LOG = new Block(11, "Oak Log", new BlockTexture("oak log.png", "oak log.png", "oak log side.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_SANDSTONE = new Block(17, "Sandstone", new BlockTexture("sandstone.png", "sandstone bottom.png", "sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_SNOW = new Block(23, "Snow", new BlockTexture("snow.png", "dirt.png", "snow side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_BOOKSHELF = new Block(24, "Bookshelf", new BlockTexture("bookshelf.png", "bookshelf.png", "bookshelf side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_CARROTS__PLANT = new Plant(122, "Carrots hidden <PLANT>", new BlockTexture("carrots  plant.png", "carrots  plant.png", "carrots  plant.png"));
    ...
    public static final Block BLOCK_BEETROOT_SEEDS = new Plant(247, "Beetroot Seeds", new BlockTexture("carrot seeds.png", "carrot seeds.png", "carrot seeds.png"));
    ...
    public static final Block BLOCK_MUSIC_BOX = new Block(35, "Music Box", new BlockTexture("music box.png", "music box side.png", "music box side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_GREY_CONCRETE = new Block(76, "Grey Concrete", new BlockTexture("grey concrete.png", "grey concrete.png", "grey concrete.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_GREY_GLAZED_TERACOTTA = new Block(77, "Grey Glazed Teracotta", new BlockTexture("grey glazed teracotta.png", "grey glazed teracotta.png", "grey glazed teracotta.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_LIGHT_GREY_CONCRETE = new Block(82, "Light Grey Concrete", new BlockTexture("light grey concrete.png", "light grey concrete.png", "light grey concrete.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_LIGHT_GREY_GLAZED_TERACOTTA = new Block(83, "Light Grey Glazed Teracotta", new BlockTexture("light grey glazed teracotta.png", "light grey glazed teracotta.png", "light grey glazed teracotta.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_QUARTZ_PILLAR_BLOCK = new Block(100, "Quartz Pillar Block", new BlockTexture("quartz.png", "quartz.png", "quartz side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_WATERMELON = new Block(105, "Watermelon", new BlockTexture("watermelon.png", "watermelon.png", "watermelon side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_CACTUS = new Block(109, "Cactus", new BlockTexture("cactus.png", "cactus bottom.png", "cactus side.png"), RenderType.PILLAR);
    public static final Block BLOCK_PALISADE_STONE = new Block(110, "Palisade Stone", new BlockTexture("palisade stone.png", "palisade stone.png", "palisade stone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_RED_SANDSTONE = new Block(111, "Red Sandstone", new BlockTexture("red sandstone.png", "red sandstone bottom.png", "red sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_WOOL_GREY = new Block(142, "Wool Grey", new BlockTexture("wool grey.png", "wool grey.png", "wool grey.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_IRON_BLOCK = new Block(145, "Iron Block", new BlockTexture("iron.png", "iron.png", "iron.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_RED_PALISADE_SANDSTONE = new Block(175, "Red Palisade Sandstone", new BlockTexture("red palisade sandstone.png", "red palisade sandstone.png", "red palisade sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_PHANTOM_SANDSTONE = new Block(176, "Phantom Sandstone", new BlockTexture("sandstone.png", "sandstone bottom.png", "sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_PALISADE_SANDSTONE = new Block(177, "Palisade Sandstone", new BlockTexture("palisade sandstone.png", "palisade sandstone.png", "palisade sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_BLACK_STAINED_GLASS = new Block(179, "Black-Stained Glass", new BlockTexture("black stained glass.png", "black stained glass.png", "black stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_BLUE_STAINED_GLASS = new Block(180, "Blue-Stained Glass", new BlockTexture("blue stained glass.png", "blue stained glass.png", "blue stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_BROWN_STAINED_GLASS = new Block(181, "Brown-Stained Glass", new BlockTexture("brown stained glass.png", "brown stained glass.png", "brown stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_CYAN_STAINED_GLASS = new Block(182, "Cyan-Stained Glass", new BlockTexture("cyan stained glass.png", "cyan stained glass.png", "cyan stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_GREY_STAINED_GLASS = new Block(183, "Grey-Stained Glass", new BlockTexture("grey stained glass.png", "grey stained glass.png", "grey stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_GREEN_STAINED_GLASS = new Block(184, "Green-Stained Glass", new BlockTexture("green stained glass.png", "green stained glass.png", "green stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_LIGHT_BLUE_STAINED_GLASS = new Block(185, "Light Blue-Stained Glass", new BlockTexture("light blue stained glass.png", "light blue stained glass.png", "light blue stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_LIGHT_GREY_STAINED_GLASS = new Block(186, "Light Grey-Stained Glass", new BlockTexture("light grey stained glass.png", "light grey stained glass.png", "light grey stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_LIME_STAINED_GLASS = new Block(187, "Lime-Stained Glass", new BlockTexture("lime stained glass.png", "lime stained glass.png", "lime stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_MAGENTA_STAINED_GLASS = new Block(188, "Magenta-Stained Glass", new BlockTexture("magenta stained glass.png", "magenta stained glass.png", "magenta stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_ORANGE_STAINED_GLASS = new Block(189, "Orange-Stained Glass", new BlockTexture("orange stained glass.png", "orange stained glass.png", "orange stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_PINK_STAINED_GLASS = new Block(190, "Pink-Stained Glass", new BlockTexture("pink stained glass.png", "pink stained glass.png", "pink stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_PURPLE_STAINED_GLASS = new Block(191, "Purple-Stained Glass", new BlockTexture("purple stained glass.png", "purple stained glass.png", "purple stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_RED_STAINED_GLASS = new Block(192, "Red-Stained Glass", new BlockTexture("red stained glass.png", "red stained glass.png", "red stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_WHITE_STAINED_GLASS = new Block(193, "White-Stained Glass", new BlockTexture("white stained glass.png", "white stained glass.png", "white stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_YELLOW_STAINED_GLASS = new Block(194, "Yellow-Stained Glass", new BlockTexture("yellow stained glass.png", "yellow stained glass.png", "yellow stained glass.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_SANDSTONE_STAIRS = new Block(202, "Sandstone Stairs", new BlockTexture("sandstone.png", "sandstone bottom.png", "sandstone side.png"), RenderType.STAIRS);
    ...
    public static final Block BLOCK_RED_SANDSTONE_SLAB = new Block(210, "Red Sandstone Slab", new BlockTexture("red sandstone.png", "red sandstone bottom.png", "red sandstone side.png"), RenderType.SLAB);
    public static final Block BLOCK_SANDSTONE_SLAB = new Block(211, "Sandstone Slab", new BlockTexture("sandstone.png", "sandstone bottom.png", "sandstone side.png"), RenderType.SLAB);
    public static final Block BLOCK_DRY_GRASS = new Block(212, "Dry Grass", new BlockTexture("dry grass.png", "dirt.png", "dry grass side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_ACACIA_LOG = new Block(226, "Acacia Log", new BlockTexture("acacia log.png", "acacia log.png", "acacia log side.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_IRON_ORE = new Block(231, "Iron Ore", new BlockTexture("iron ore.png", "iron ore.png", "iron ore.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_HAY_BAIL = new Block(242, "Hay Bail", new BlockTexture("hay bail.png", "hay bail.png", "hay bail side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_RED_SANDSTONE_STAIRS = new Block(259, "Red Sandstone Stairs", new BlockTexture("red sandstone.png", "red sandstone bottom.png", "red sandstone side.png"), RenderType.STAIRS);
    ...
    public static final Block BLOCK_PALISADE_STONE_STAIRS = new Block(268, "Palisade Stone Stairs", new BlockTexture("palisade stone.png", "palisade stone.png", "palisade stone side.png"), RenderType.STAIRS);
    public static final Block BLOCK_PALISADE_STONE_SLAB = new Block(269, "Palisade Stone Slab", new BlockTexture("palisade stone.png", "palisade stone.png", "palisade stone side.png"), RenderType.SLAB);
    public static final Block BLOCK_PALISADE_STONE_FENCE = new Block(270, "Palisade Stone Fence", new BlockTexture("palisade stone.png", "palisade stone.png", "palisade stone side.png"), RenderType.FENCE);
    ...
    public static final Block BLOCK_RED_PALISADE_SANDSTONE_STAIRS = new Block(287, "Red Palisade Sandstone Stairs", new BlockTexture("red palisade sandstone.png", "red palisade sandstone.png", "red palisade sandstone side.png"), RenderType.STAIRS);
    public static final Block BLOCK_RED_PALISADE_SANDSTONE_SLAB = new Block(288, "Red Palisade Sandstone Slab", new BlockTexture("red palisade sandstone.png", "red palisade sandstone.png", "red palisade sandstone side.png"), RenderType.SLAB);
    public static final Block BLOCK_RED_PALISADE_SANDSTONE_FENCE = new Block(289, "Red Palisade Sandstone Fence", new BlockTexture("red palisade sandstone.png", "red palisade sandstone.png", "red palisade sandstone side.png"), RenderType.FENCE);
    public static final Block BLOCK_PALISADE_SANDSTONE_STAIRS = new Block(290, "Palisade Sandstone Stairs", new BlockTexture("palisade sandstone.png", "palisade sandstone.png", "palisade sandstone side.png"), RenderType.STAIRS);
    public static final Block BLOCK_PALISADE_SANDSTONE_SLAB = new Block(291, "Palisade Sandstone Slab", new BlockTexture("palisade sandstone.png", "palisade sandstone.png", "palisade sandstone side.png"), RenderType.SLAB);
    public static final Block BLOCK_PALISADE_SANDSTONE_FENCE = new Block(292, "Palisade Sandstone Fence", new BlockTexture("palisade sandstone.png", "palisade sandstone.png", "palisade sandstone side.png"), RenderType.FENCE);
    ...
    public static final Block BLOCK_WOOL_GREY_STAIRS = new Block(295, "Wool Grey Stairs", new BlockTexture("wool grey.png", "wool grey.png", "wool grey.png"), RenderType.STAIRS);
    public static final Block BLOCK_WOOL_GREY_SLAB = new Block(296, "Wool Grey Slab", new BlockTexture("wool grey.png", "wool grey.png", "wool grey.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_GREY_CONCRETE_STAIRS = new Block(338, "Grey Concrete Stairs", new BlockTexture("grey concrete.png", "grey concrete.png", "grey concrete.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_CONCRETE_SLAB = new Block(339, "Grey Concrete Slab", new BlockTexture("grey concrete.png", "grey concrete.png", "grey concrete.png"), RenderType.SLAB);
    public static final Block BLOCK_GREY_CONCRETE_FENCE = new Block(340, "Grey Concrete Fence", new BlockTexture("grey concrete.png", "grey concrete.png", "grey concrete.png"), RenderType.FENCE);
    ...
    public static final Block BLOCK_LIGHT_GREY_CONCRETE_STAIRS = new Block(347, "Light Grey Concrete Stairs", new BlockTexture("light grey concrete.png", "light grey concrete.png", "light grey concrete.png"), RenderType.STAIRS);
    public static final Block BLOCK_LIGHT_GREY_CONCRETE_SLAB = new Block(348, "Light Grey Concrete Slab", new BlockTexture("light grey concrete.png", "light grey concrete.png", "light grey concrete.png"), RenderType.SLAB);
    public static final Block BLOCK_LIGHT_GREY_CONCRETE_FENCE = new Block(349, "Light Grey Concrete Fence", new BlockTexture("light grey concrete.png", "light grey concrete.png", "light grey concrete.png"), RenderType.FENCE);
    ...
    public static final Block BLOCK_GREY_GLAZED_TERACOTTA_STAIRS = new Block(381, "Grey Glazed Teracotta Stairs", new BlockTexture("grey glazed teracotta.png", "grey glazed teracotta.png", "grey glazed teracotta.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_GLAZED_TERACOTTA_SLAB = new Block(382, "Grey Glazed Teracotta Slab", new BlockTexture("grey glazed teracotta.png", "grey glazed teracotta.png", "grey glazed teracotta.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_LIGHT_GREY_GLAZED_TERACOTTA_STAIRS = new Block(387, "Light Grey Glazed Teracotta Stairs", new BlockTexture("light grey glazed teracotta.png", "light grey glazed teracotta.png", "light grey glazed teracotta.png"), RenderType.STAIRS);
    public static final Block BLOCK_LIGHT_GREY_GLAZED_TERACOTTA_SLAB = new Block(388, "Light Grey Glazed Teracotta Slab", new BlockTexture("light grey glazed teracotta.png", "light grey glazed teracotta.png", "light grey glazed teracotta.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_MINECART_ROAD_BLOCK = new Block(404, "Minecart Road Block", new BlockTexture("minecart road.png", "minecart road side.png", "minecart road side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_MINECART_ROAD_SLAB = new Block(408, "Minecart Road Slab", new BlockTexture("minecart road.png", "minecart road side.png", "minecart road side.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_GLASS_STAIRS = new Block(411, "Glass Stairs", new BlockTexture("glass.png", "glass.png", "glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_GLASS_SLAB = new Block(412, "Glass Slab", new BlockTexture("glass.png", "glass.png", "glass.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_RED_SANDSTONE_PILLAR = new Block(439, "Red Sandstone Pillar", new BlockTexture("red sandstone.png", "red sandstone bottom.png", "red sandstone side.png"), RenderType.PILLAR);
    ...
    public static final Block BLOCK_PALISADE_SANDSTONE_PILLAR = new Block(441, "Palisade Sandstone Pillar", new BlockTexture("palisade sandstone.png", "palisade sandstone.png", "palisade sandstone side.png"), RenderType.PILLAR);
    public static final Block BLOCK_PALISADE_STONE_PILLAR = new Block(442, "Palisade Stone Pillar", new BlockTexture("palisade stone.png", "palisade stone.png", "palisade stone side.png"), RenderType.PILLAR);
    ...
    public static final Block BLOCK_RED_PALISADE_SANDSTONE_PILLAR = new Block(448, "Red Palisade Sandstone Pillar", new BlockTexture("red palisade sandstone.png", "red palisade sandstone.png", "red palisade sandstone side.png"), RenderType.PILLAR);
    public static final Block BLOCK_MARBLE_PILLAR_BLOCK = new Block(449, "Marble Pillar Block", new BlockTexture("marble.png", "marble.png", "marble side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_QUARTZ_PILLAR = new Block(450, "Quartz Pillar", new BlockTexture("quartz.png", "quartz.png", "quartz side.png"), RenderType.PILLAR);
    public static final Block BLOCK_MARBLE_PILLAR = new Block(451, "Marble Pillar", new BlockTexture("marble.png", "marble.png", "marble side.png"), RenderType.PILLAR);
    ...
    public static final Block BLOCK_ENGRAVED_SANDSTONE = new Block(460, "Engraved Sandstone", new BlockTexture("sandstone.png", "sandstone.png", "engraved sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_ENGRAVED_RED_SANDSTONE = new Block(461, "Engraved Red Sandstone", new BlockTexture("red sandstone.png", "red sandstone.png", "engraved red sandstone side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_GREY_MARBLE_TILE = new Block(470, "Grey Marble Tile", new BlockTexture("grey marble tile.png", "grey marble tile.png", "grey marble tile.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_YELLOW_STAINED_GLASS_STAIRS = new Block(473, "Yellow-Stained Glass Stairs", new BlockTexture("yellow stained glass.png", "yellow stained glass.png", "yellow stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_YELLOW_STAINED_GLASS_SLAB = new Block(474, "Yellow-Stained Glass Slab", new BlockTexture("yellow stained glass.png", "yellow stained glass.png", "yellow stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_BLACK_STAINED_GLASS_STAIRS = new Block(475, "Black-Stained Glass Stairs", new BlockTexture("black stained glass.png", "black stained glass.png", "black stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_BLACK_STAINED_GLASS_SLAB = new Block(476, "Black-Stained Glass Slab", new BlockTexture("black stained glass.png", "black stained glass.png", "black stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_BLUE_STAINED_GLASS_STAIRS = new Block(477, "Blue-Stained Glass Stairs", new BlockTexture("blue stained glass.png", "blue stained glass.png", "blue stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_BLUE_STAINED_GLASS_SLAB = new Block(478, "Blue-Stained Glass Slab", new BlockTexture("blue stained glass.png", "blue stained glass.png", "blue stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_BROWN_STAINED_GLASS_STAIRS = new Block(479, "Brown-Stained Glass Stairs", new BlockTexture("brown stained glass.png", "brown stained glass.png", "brown stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_BROWN_STAINED_GLASS_SLAB = new Block(480, "Brown-Stained Glass Slab", new BlockTexture("brown stained glass.png", "brown stained glass.png", "brown stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_CYAN_STAINED_GLASS_STAIRS = new Block(481, "Cyan-Stained Glass Stairs", new BlockTexture("cyan stained glass.png", "cyan stained glass.png", "cyan stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_CYAN_STAINED_GLASS_SLAB = new Block(482, "Cyan-Stained Glass Slab", new BlockTexture("cyan stained glass.png", "cyan stained glass.png", "cyan stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_GREY_STAINED_GLASS_STAIRS = new Block(483, "Grey-Stained Glass Stairs", new BlockTexture("grey stained glass.png", "grey stained glass.png", "grey stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_STAINED_GLASS_SLAB = new Block(484, "Grey-Stained Glass Slab", new BlockTexture("grey stained glass.png", "grey stained glass.png", "grey stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_GREEN_STAINED_GLASS_STAIRS = new Block(485, "Green-Stained Glass Stairs", new BlockTexture("green stained glass.png", "green stained glass.png", "green stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREEN_STAINED_GLASS_SLAB = new Block(486, "Green-Stained Glass Slab", new BlockTexture("green stained glass.png", "green stained glass.png", "green stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_LIGHT_BLUE_STAINED_GLASS_STAIRS = new Block(487, "Light Blue-Stained Glass Stairs", new BlockTexture("light blue stained glass.png", "light blue stained glass.png", "light blue stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_LIGHT_BLUE_STAINED_GLASS_SLAB = new Block(488, "Light Blue-Stained Glass Slab", new BlockTexture("light blue stained glass.png", "light blue stained glass.png", "light blue stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_LIGHT_GREY_STAINED_GLASS_STAIRS = new Block(489, "Light Grey-Stained Glass Stairs", new BlockTexture("light grey stained glass.png", "light grey stained glass.png", "light grey stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_LIGHT_GREY_STAINED_GLASS_SLAB = new Block(490, "Light Grey-Stained Glass Slab", new BlockTexture("light grey stained glass.png", "light grey stained glass.png", "light grey stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_LIME_STAINED_GLASS_STAIRS = new Block(491, "Lime-Stained Glass Stairs", new BlockTexture("lime stained glass.png", "lime stained glass.png", "lime stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_LIME_STAINED_GLASS_SLAB = new Block(492, "Lime-Stained Glass Slab", new BlockTexture("lime stained glass.png", "lime stained glass.png", "lime stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_MAGENTA_STAINED_GLASS_STAIRS = new Block(493, "Magenta-Stained Glass Stairs", new BlockTexture("magenta stained glass.png", "magenta stained glass.png", "magenta stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_MAGENTA_STAINED_GLASS_SLAB = new Block(494, "Magenta-Stained Glass Slab", new BlockTexture("magenta stained glass.png", "magenta stained glass.png", "magenta stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_ORANGE_STAINED_GLASS_STAIRS = new Block(495, "Orange-Stained Glass Stairs", new BlockTexture("orange stained glass.png", "orange stained glass.png", "orange stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_ORANGE_STAINED_GLASS_SLAB = new Block(496, "Orange-Stained Glass Slab", new BlockTexture("orange stained glass.png", "orange stained glass.png", "orange stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_PINK_STAINED_GLASS_STAIRS = new Block(497, "Pink-Stained Glass Stairs", new BlockTexture("pink stained glass.png", "pink stained glass.png", "pink stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_PINK_STAINED_GLASS_SLAB = new Block(498, "Pink-Stained Glass Slab", new BlockTexture("pink stained glass.png", "pink stained glass.png", "pink stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_PURPLE_STAINED_GLASS_STAIRS = new Block(499, "Purple-Stained Glass Stairs", new BlockTexture("purple stained glass.png", "purple stained glass.png", "purple stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_PURPLE_STAINED_GLASS_SLAB = new Block(500, "Purple-Stained Glass Slab", new BlockTexture("purple stained glass.png", "purple stained glass.png", "purple stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_RED_STAINED_GLASS_STAIRS = new Block(501, "Red-Stained Glass Stairs", new BlockTexture("red stained glass.png", "red stained glass.png", "red stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_RED_STAINED_GLASS_SLAB = new Block(502, "Red-Stained Glass Slab", new BlockTexture("red stained glass.png", "red stained glass.png", "red stained glass.png"), RenderType.SLAB);
    public static final Block BLOCK_WHITE_STAINED_GLASS_STAIRS = new Block(503, "White-Stained Glass Stairs", new BlockTexture("white stained glass.png", "white stained glass.png", "white stained glass.png"), RenderType.STAIRS);
    public static final Block BLOCK_WHITE_STAINED_GLASS_SLAB = new Block(504, "White-Stained Glass Slab", new BlockTexture("white stained glass.png", "white stained glass.png", "white stained glass.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_GREY_MARBLE_TILE_STAIRS = new Block(511, "Grey Marble Tile Stairs", new BlockTexture("grey marble tile.png", "grey marble tile.png", "grey marble tile.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_MARBLE_TILE_SLAB = new Block(512, "Grey Marble Tile Slab", new BlockTexture("grey marble tile.png", "grey marble tile.png", "grey marble tile.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_GREY_MARBLE_TILE_PILLAR = new Block(519, "Grey Marble Tile Pillar", new BlockTexture("grey marble tile.png", "grey marble tile.png", "grey marble tile.png"), RenderType.PILLAR);
    ...
    public static final Block BLOCK_GLASS_PANE = new Block(526, "Glass Pane", new BlockTexture("glass.png", "glass.png", "glass.png"), RenderType.PANE);
    public static final Block BLOCK_YELLOW_STAINED_GLASS_PANE = new Block(527, "Yellow-Stained Glass Pane", new BlockTexture("yellow stained glass.png", "yellow stained glass.png", "yellow stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_BLACK_STAINED_GLASS_PANE = new Block(528, "Black-Stained Glass Pane", new BlockTexture("black stained glass.png", "black stained glass.png", "black stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_BLUE_STAINED_GLASS_PANE = new Block(529, "Blue-Stained Glass Pane", new BlockTexture("blue stained glass.png", "blue stained glass.png", "blue stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_BROWN_STAINED_GLASS_PANE = new Block(530, "Brown-Stained Glass Pane", new BlockTexture("brown stained glass.png", "brown stained glass.png", "brown stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_CYAN_STAINED_GLASS_PANE = new Block(531, "Cyan-Stained Glass Pane", new BlockTexture("cyan stained glass.png", "cyan stained glass.png", "cyan stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_GREY_STAINED_GLASS_PANE = new Block(532, "Grey-Stained Glass Pane", new BlockTexture("grey stained glass.png", "grey stained glass.png", "grey stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_GREEN_STAINED_GLASS_PANE = new Block(533, "Green-Stained Glass Pane", new BlockTexture("green stained glass.png", "green stained glass.png", "green stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_LIGHT_BLUE_STAINED_GLASS_PANE = new Block(534, "Light Blue-Stained Glass Pane", new BlockTexture("light blue stained glass.png", "light blue stained glass.png", "light blue stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_LIGHT_GREY_STAINED_GLASS_PANE = new Block(535, "Light Grey-Stained Glass Pane", new BlockTexture("light grey stained glass.png", "light grey stained glass.png", "light grey stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_LIME_STAINED_GLASS_PANE = new Block(536, "Lime-Stained Glass Pane", new BlockTexture("lime stained glass.png", "lime stained glass.png", "lime stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_MAGENTA_STAINED_GLASS_PANE = new Block(537, "Magenta-Stained Glass Pane", new BlockTexture("magenta stained glass.png", "magenta stained glass.png", "magenta stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_ORANGE_STAINED_GLASS_PANE = new Block(538, "Orange-Stained Glass Pane", new BlockTexture("orange stained glass.png", "orange stained glass.png", "orange stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_PINK_STAINED_GLASS_PANE = new Block(539, "Pink-Stained Glass Pane", new BlockTexture("pink stained glass.png", "pink stained glass.png", "pink stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_PURPLE_STAINED_GLASS_PANE = new Block(540, "Purple-Stained Glass Pane", new BlockTexture("purple stained glass.png", "purple stained glass.png", "purple stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_RED_STAINED_GLASS_PANE = new Block(541, "Red-Stained Glass Pane", new BlockTexture("red stained glass.png", "red stained glass.png", "red stained glass.png"), RenderType.PANE);
    public static final Block BLOCK_WHITE_STAINED_GLASS_PANE = new Block(542, "White-Stained Glass Pane", new BlockTexture("white stained glass.png", "white stained glass.png", "white stained glass.png"), RenderType.PANE);
    ...
    public static final Block BLOCK_GREY_CHISELED_MARBLE_TILE = new Block(557, "Grey Chiseled Marble Tile", new BlockTexture("grey chiseled marble tile.png", "grey chiseled marble tile.png", "grey chiseled marble tile.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_BAMBOO_BLOCK = new Block(566, "Bamboo Block", new BlockTexture("bamboo.png", "bamboo.png", "bamboo side.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_GREY_CHISELED_MARBLE_TILE_STAIRS = new Block(646, "Grey Chiseled Marble Tile Stairs", new BlockTexture("grey chiseled marble tile.png", "grey chiseled marble tile.png", "grey chiseled marble tile.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_CHISELED_MARBLE_TILE_SLAB = new Block(647, "Grey Chiseled Marble Tile Slab", new BlockTexture("grey chiseled marble tile.png", "grey chiseled marble tile.png", "grey chiseled marble tile.png"), RenderType.SLAB);
    public static final Block BLOCK_GREY_CHISELED_MARBLE_TILE_PILLAR = new Block(648, "Grey Chiseled Marble Tile Pillar", new BlockTexture("grey chiseled marble tile.png", "grey chiseled marble tile.png", "grey chiseled marble tile.png"), RenderType.PILLAR);
    ...
    public static final Block BLOCK_GREY_STAINED_WOOD = new Block(666, "Grey Stained Wood", new BlockTexture("grey stained wood.png", "grey stained wood.png", "grey stained wood.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_ENGRAVED_SANDSTONE_2 = new Block(676, "Engraved Sandstone 2", new BlockTexture("sandstone.png", "sandstone.png", "engraved sandstone 2 side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    public static final Block BLOCK_ENGRAVED_RED_SANDSTONE_2 = new Block(677, "Engraved Red Sandstone 2", new BlockTexture("red sandstone.png", "red sandstone.png", "engraved red sandstone 2 side.png"), BlockList.DEFAULT_BLOCK_TYPE_ID);
    ...
    public static final Block BLOCK_SOLAR_PANEL = new Block(681, "Solar Panel", new BlockTexture("solar l.png", "solar l side.png", "solar l side.png"), RenderType.SLAB);
    ...
    public static final Block BLOCK_GREY_STAINED_WOOD_STAIRS = new Block(697, "Grey Stained Wood Stairs", new BlockTexture("grey stained wood.png", "grey stained wood.png", "grey stained wood.png"), RenderType.STAIRS);
    public static final Block BLOCK_GREY_STAINED_WOOD_SLAB = new Block(698, "Grey Stained Wood Slab", new BlockTexture("grey stained wood.png", "grey stained wood.png", "grey stained wood.png"), RenderType.SLAB);
    public static final Block BLOCK_GREY_STAINED_WOOD_FENCE = new Block(699, "Grey Stained Wood Fence", new BlockTexture("grey stained wood.png", "grey stained wood.png", "grey stained wood.png"), RenderType.FENCE);
    ...
    public static final Block BLOCK_SPRUCE_LOG = new Block(732, "Spruce Log", new BlockTexture("spruce log.png", "spruce log.png", "spruce log side.png"), RenderType.ORIENTABLE_BLOCK);
    ...
    public static final Block BLOCK_PASTE_VERTEX_BLOCK = new Block(735, "Paste Vertex Block", new BlockTexture("paste rotate.png", "paste rotate.png", "paste vertex side.png"), RenderType.SLAB);
