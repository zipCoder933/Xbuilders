...
public class NaiveMesherWithLight {
    ...
    public void compute(BufferSet opaqueBuffers, BufferSet transparentBuffers, Vector3i chunkPosition) {
        Block block;
        ...
        for (int x = 0; x < data.size.x; ++x) {
            for (int y = 0; y < data.size.y; ++y) {
                for (int z = 0; z < data.size.z; ++z) {
                    ...
                    byte centerLight = data.getSun(x, y, z);
                    ...
                    if (!block.isAir() && (block.type != BlockList.DEFAULT_BLOCK_TYPE_ID || generateAll)) {
                        ...
                        if (x > 0) {
                            ...
                            lightNeghbors[BlockType.NEG_X] = block.opaque ? data.getSun(x - 1, y, z) : centerLight;
                            ...
                            lightNeghbors[BlockType.NEG_X] = negXNeghbor.data.getSun(negXNeghbor.data.size.x - 1, y, z);
                        } else {
                        ...
                        if (x < data.size.x - 1) {
                            ...
                            lightNeghbors[BlockType.POS_X] = block.opaque ? data.getSun(x + 1, y, z) : centerLight;
                        } else if (posXNeghbor != null) {
                            neighbors[BlockType.POS_X] = ItemList.getBlock(posXNeghbor.data.getBlock(0, y, z));
                            lightNeghbors[BlockType.POS_X] = posXNeghbor.data.getSun(0, y, z);
                        } else {
                        ...
                        if (y > 0) {
                            ...
                            lightNeghbors[BlockType.NEG_Y] = block.opaque ? data.getSun(x, y - 1, z) : centerLight;
                            ...
                            lightNeghbors[BlockType.NEG_Y] = negYNeghbor.data.getSun(x, negYNeghbor.data.size.y - 1, z);
                        }else {
                        ...
                        if (y < data.size.y - 1) {
                            ...
                            lightNeghbors[BlockType.POS_Y] = block.opaque ? data.getSun(x, y + 1, z) : centerLight;
                        } else if (posYNeghbor != null) {
                            neighbors[BlockType.POS_Y] = ItemList.getBlock(posYNeghbor.data.getBlock(x, 0, z));
                            lightNeghbors[BlockType.POS_Y] = posYNeghbor.data.getSun(x, 0, z);
                        } else {
                        ...
                        if (z > 0) {
                            ...
                            lightNeghbors[BlockType.NEG_Z] = block.opaque ? data.getSun(x, y, z - 1) : centerLight;
                            ...
                            lightNeghbors[BlockType.NEG_Z] = negZNeghbor.data.getSun(x, y, negZNeghbor.data.size.z - 1);
                        }else {
                        ...
                        if (z < data.size.z - 1) {
                            ...
                            lightNeghbors[BlockType.POS_Z] = block.opaque ? data.getSun(x, y, z + 1) : centerLight;
                        } else if (posZNeghbor != null) {
                            neighbors[BlockType.POS_Z] = ItemList
                                    .getBlock(posZNeghbor.data.getBlock(x, y, 0));
                            lightNeghbors[BlockType.POS_Z] = posZNeghbor.data.getSun(x, y, 0);
                        } else {
