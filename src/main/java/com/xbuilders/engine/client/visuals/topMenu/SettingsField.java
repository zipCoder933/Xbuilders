...
class SettingsField {
    ...
    public SettingsField(ClientWindow window, Field field) throws IllegalAccessException {
        this.field = field;
        this.key = formatKey(field.getName());
        this.type = field.getType();
        this.value = field.get(ClientWindow.settings);
    ...
    public void setValue(Object value) {
        try {
            field.set(ClientWindow.settings, value);
            this.value = value;
            ClientWindow.settings.save();
