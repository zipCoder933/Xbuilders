...
//        }
    ...
    private byte getLightVal(int pos[]) {
        ...
        if (Chunk.inBounds(pos[0], pos[1], pos[2])) {// Center
            ...
            Chunk chunk = WCCi.getNeighboringChunk(LocalClient.world, chunkPosition, pos[0], pos[1], pos[2]);
            if (chunk != null) {
