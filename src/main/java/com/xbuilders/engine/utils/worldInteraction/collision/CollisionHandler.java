...
//    private void processBoxXZ(AABB box, Block block, boolean isEntity) {
//        if (box.intersects(myBox.box) && calculateCollisionData(box, block, isEntity)) {
...
//    }
//
//    private void processBoxY(AABB box, Block block, boolean isEntity) {
//        if (box.intersects(myBox.box) && calculateCollisionData(box, block, isEntity)) {
//            //Floor collision
